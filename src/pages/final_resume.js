...
export const Finalresume = ({ final }) => {
  console.log(final);
          ...
          <div className="maincontainer">
            <div className="output">
              ...
              <div className="container">
                ...
                <h1 className="college-qualification">
                  {final.collegequalification + "\n" + final.collegedescription}
                </h1>
                <div className="container">
                  <p className="address">{final.address}</p>
                </div>
                <div className="contact-div">
                  <p className="contact-head">
                    <b>Contact:</b>
                  </p>
                  <p className="contact-text">&nbsp;{final.phonenumber}</p>
                </div>
                ...
                <h1 className="acadamic-credentials">
                ...
                <table className="education">
                  <tbody>
                    ...
                    <tr className="tr-font">
                      ...
                      <td>{final.collegename}</td>
                      <td>{final.collegedate}</td>
                      <td>{final.collegecgpa}</td>
                    </tr>
                    <tr className="tr-font">
                      <td>{final.hscschoolqualification}</td>
                      <td>{final.hscschoolname}</td>
                      <td>{final.hscschooldate}</td>
                      <td>{final.hscschoolpercentage}</td>
                    </tr>
                    <tr className="tr-font">
                      <td>{final.sslcschoolqualification}</td>
                      <td>{final.sslcschoolname}</td>
                      <td>{final.sslcschooldate}</td>
                      <td>{final.sslcschoolpercentage}</td>
                    </tr>
                  </tbody>
                </table>
                <br />
                ...
                <div className="container" id="project-1">
                  ...
                  <p className="project" style={{ marginLeft: "1%" }}>
                    <b>Link:</b>
                    <Link>&ensp;{"\n" + "\n" + final.project1link}</Link>
                  </p>
                  <p className="project" style={{ marginLeft: "1%" }}>
                    <b>Description:</b>&ensp;
                    {"\n" + "\n" + final.project1description}
                  </p>
                </div>
                ...
                <h1 className="technical-skill">
                  {final.skill1 ? "TECHNICAL SKILLS:" : ""}
                </h1>
                <br />
                ...
                <br />
                <div className="container" className="workshop-1">
                  <li>{final.workshop1}</li>
                </div>
                ...
                >
                  <p className="father-name">
                    <b>Father Name:</b>&ensp;
                    {"\n" + "\n" + "\n" + final.fathername}
                  </p>
                  <p className="detail">
                    <b>Date of Birth:</b>&ensp;
                    {"\n" + "\n" + "\n" + final.dateofbirth}
                  </p>
                  <p className="detail">
                    <b>Gender:</b>&ensp;{"\n" + "\n" + "\n" + final.gender}
                  ...
                  <p className="detail">
                    <b>Marital Status:</b>&ensp;
                    {"\n" + "\n" + "\n" + final.maritalstatus}
                  </p>
                  <p className="detail">
                    <b>Nationality:</b>&ensp;
                    {"\n" + "\n" + "\n" + final.nationality}
                  </p>
                  <p className="detail">
                    <b>Language Proficiency:</b>&ensp;
